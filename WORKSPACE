...
http_archive(
    name = "yaml_cpp",
    build_file = "//bazel/third_party:yaml_cpp.BUILD",
...
http_archive(
    ...
    build_file = "//bazel/third_party:curl.BUILD",
)
...
http_archive(
    ...
    build_file = "//bazel/third_party/imagemagick:imagemagick.BUILD",
)

http_archive(
    name = "com_github_sparsehash",
    build_file = "//bazel/third_party/sparsehash:BUILD.sparsehash",
...
http_archive(
    name = "iceoryx_posh",
    url = "https://github.com/eclipse-iceoryx/iceoryx/archive/9e795aac7393711bfbca6f4c56539939c1cbd294.tar.gz",
    #sha256 = "34af2f15cf7367513b352bdcd2493ab14ce43692d2dcd9dfc499492966c64dcf",
...
load("@iceoryx_posh//bazel:load_repositories.bzl", "load_repositories")
load_repositories()
