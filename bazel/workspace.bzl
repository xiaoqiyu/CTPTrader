...
def brpc_workspace():
    ...
    http_archive(
        name = "yaml_cpp",
        build_file = str(Label("//app/bazel:yaml_cpp.BUILD")),
    ...
    http_archive(
        name = "tinyxml2",
        build_file = str(Label("//app/bazel:tinyxml2.BUILD")),
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel:openssl.BUILD")),
    )
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel:curl.BUILD")),
    )
    ...
    #    build_file = str(Label("//app/bazel:zlib.BUILD")),
    #)
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel/imagemagick:imagemagick.BUILD")),
    )
    ...
    #    build_file = str(Label("//app/bazel:bzip2.BUILD")),
    #)
    ...
    #    build_file = str(Label("//app/bazel:xz.BUILD")),
    #)
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel:freetype2.BUILD")),
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel:gd.BUILD")),
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel/fontconfig:fontconfig.BUILD")),
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel:expat.BUILD")),
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel:fftw.BUILD")),
    )

    http_archive(
        name = "libjpeg",
        build_file = str(Label("//app/bazel:libjpeg.BUILD")),
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel:libpng.BUILD")),
    ...
    http_archive(
        name = "org_lua_lua",
        build_file = str(Label("//app/bazel:lua.BUILD")),
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel:gif.BUILD")),
    )
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel/tiff:tiff.BUILD")),
    )
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel:nasm.BUILD")),
    )

    http_archive(
        name = "com_github_sparsehash",
        build_file = str(Label("//app/bazel/sparsehash:BUILD.sparsehash")),
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel:rapidjson.BUILD")),
    )
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel:double-conversion.BUILD")),
    )
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel/folly:folly.BUILD")),
    )
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel/jemalloc:jemalloc.BUILD")),
    )
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel/libevent:libevent.BUILD")),
    )
    ...
    http_archive(
        ...
        build_file = str(Label("//app/bazel/snappy:snappy.BUILD")),
    )
