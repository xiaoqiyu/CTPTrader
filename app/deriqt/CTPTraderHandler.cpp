...
void CTPTraderHandler::processRtnOrder(Task* task)
{
	if (task->task_data)
	{
        ...
        //ֻ�б������ڵ��ڵ�¼���������ұ���ʱ��ȵ�¼ʱ�������Żᴦ���������߼��Ļ������൱��ҹ�̱������ҹ��ʱ��û�д���callback���ڶ������̿��̲��ᴦ������Ϊ��ʹ������һ�����������ڲ�ͬ��
        // _login_time �ǵ�½ʱ���صĽ�����ʱ�䣬task_data inserttimeҲ�ǽ���������ʱ��
        if(!(strcmp(task_data->InsertTime, _login_time) > 0 && _is_same_date )){
            ...
            order_available_ = true; //���Զ���֮���ͷŶ����ɲ�ѯ��
            cond_.notify_all();
            return;
        }
        ...
        //the 2nd order callback, when the order is accepted by the exchange
            ...
            p_orderfield->VolumeTotal = task_data->VolumeTotal;
            p_orderfield->OrderStatus = task_data->OrderStatus;
            // p_orderfield->InsertTime = now_time; //�ڶ���callback ���޸�ί��ʱ��
            if(p_orderfield->OrderStatus == THOST_FTDC_OST_Canceled){ //TODO check whether there is other status to handle here, if cancel,the order is removed, and not processed
                LOG(INFO)<<"[update order table] remove order when canceled with order_id1=>"<<_order_id1; //�����Ļ��ͷŶ�����ѯ��������ί��������
        ...
        if(trade_product && task_data->OrderStatus == THOST_FTDC_OST_Canceled){//����ǽ��׵�Ʒ�֣����Ҷ����������ͷŶ�����
            order_complete_ = true;
...
// TODO: ���ظú�Լ instrument_id�е��ճֲֵģ�TodayPosition >0) �ļ�¼�������T0�趨������Ҫ��Ҫrename, ��verify order��risk monitor�е���
...
// ƽ�������������µĳֲ֣�1. �ֲֵĺ�Լ�Ǹò���cover��Ʒ�֣�product_id/task_tag), 2. �ú�Լ�е��ճֲ�
